<template>
  <NuxtLayout>
    <ContentBlock v-if="success === 'true'" :image="workshopInfo.image" :alt="workshopInfo.title">
      <template #heading>
    ...
    <ContentBlock v-if="success === 'false'" image="/card_b3crwd.png" alt="Uh-oh, something went wrong">
      <template #heading>
