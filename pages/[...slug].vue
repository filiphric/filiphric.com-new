...
useHead({
  ...
  {
    name: 'image',
    content: `https://filiphric-com-og.vercel.app/api/og?${encodeURIComponent(page.value.image)}&title=${encodeURIComponent(page.value.title)}readingTime=${page.value.readingTime}`
  },
  {
    property: 'og:url',
